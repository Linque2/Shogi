...
public class JogadorGyokushou extends Jogador {
     ...
     * O gyokushou, jogador com maior score, arremessa 5 peões
     * se o número de peões com a face padrão virada para cima for maior ou igual a 3, o Gyokushou começa a partida
     * caso o número de peões com a face promovida virada para cima for maior ou igual a 3, o Oushou começa a partida
