...
public class Bispo extends Peça {
    ...
    public void atualizarImagem() {
        ...
        if (getJogador() instanceof JogadorGyokushou) {
            getListImageIcon().add(new ImageIcon("ImagensInvertidas/Bispo.png"));
            getListImageIcon().add(new ImageIcon("ImagensInvertidas/Bispo_P.png"));
        } else if (getJogador() instanceof JogadorOushou) {
            getListImageIcon().add(new ImageIcon("Images/Bispo.png"));
            getListImageIcon().add(new ImageIcon("Images/Bispo_P.png"));
        }
    }
