...
public class Peão extends Peça{
    ...
    public void atualizarImagem() {
        ...
        if (getJogador() instanceof JogadorGyokushou) {
            getListImageIcon().add(new ImageIcon("ImagensInvertidas/Peão.png"));
            getListImageIcon().add(new ImageIcon("ImagensInvertidas/Peão_P.png"));
        } else if (getJogador() instanceof JogadorOushou) {
            getListImageIcon().add(new ImageIcon("Images/Peão.png"));
            getListImageIcon().add(new ImageIcon("Images/Peão_P.png"));
        }
    }    
}
